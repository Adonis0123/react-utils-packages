        ...
        ? (
            <>
              ...
              <p className='text-sm text-slate-600'>
                This page is hosted in Next.js and demonstrates the migrated `@adonis-kit/layouts` behavior.
              </p>
            </>
          )
        : (
            <p className='text-sm text-slate-600'>
              Live preview of `withLayouts` rendered with `@adonis-kit/ui` components.
            </p>
          )}
      <div>
